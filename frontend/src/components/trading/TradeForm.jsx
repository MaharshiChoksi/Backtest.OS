    ...
    <div style={{ padding: 14, borderBottom: `1px solid ${C.border}`, flexShrink: 0 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 10 }}>
        <div>
          ...
          <input type="number" step="any" value={sl} onChange={(e) => setSl(e.target.value)} style={inp} placeholder="optional" />
        </div>
        <div>
          <label style={lbl}>Take Profit</label>
          <input type="number" step="any" value={tp} onChange={(e) => setTp(e.target.value)} style={inp} placeholder="optional" />
        </div>
      </div>
